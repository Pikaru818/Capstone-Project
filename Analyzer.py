...
def BoxP(data,col):
    ...
    axs[1, 0].boxplot(data[col[5]])
    axs[1, 0].set_title(columns[5])

    axs[1, 1].boxplot(data[col[6]])
    axs[1, 1].set_title(columns[6])
    
    axs[1, 2].boxplot(data[col[7]])
    axs[1, 2].set_title(columns[7])
