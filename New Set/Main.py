...
scale_columns = ['Temp_C', 'Dew Point Temp_C', 'Rel Hum_%',
...
CLA.KClass(XC_train, XC_test, yC_train, yC_test,4)
#%%
...
CLA.RanFor(XC_train, XC_test, yC_train, yC_test,'entropy')
#%%
...
CLA.SupVec(XC_train, XC_test, yC_train, yC_test,1,1)
#%%
...
XR = df2.drop('Visibility_km',axis=1)
XR

yR= df2['Visibility_km']
yR
...
#Here you should input the K value you found would work best (in your opinion) as the last value
RE.KReg(XR_train, XR_test, yR_train, yR_test,10)
#%%
...
RE.RanFor(XR_train, XR_test, yR_train, yR_test,"squared_error",60)
#%%
