...
def HClus(a,b):
    ...
    sns.scatterplot(a.iloc[Ay == 5, 0], a.iloc[Ay == 5, 1], color = 'teal', label = 'Cluster 5',s=50)
    sns.scatterplot(a.iloc[Ay == 6, 0], a.iloc[Ay == 6, 1], color = 'black', label = 'Cluster 5',s=50)
    sns.scatterplot(a.iloc[Ay == 7, 0], a.iloc[Ay == 7, 1], color = 'purple', label = 'Cluster 5',s=50)
